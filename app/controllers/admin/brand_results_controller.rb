...
class Admin::BrandResultsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     BrandResult: create, read, update, destroy, custom_action
  #
  #   editor:
  #     BrandResult: create, read, update, custom_action_for_an_item
  #
