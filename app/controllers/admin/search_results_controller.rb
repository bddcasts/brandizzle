...
class Admin::SearchResultsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     SearchResult: create, read, update, destroy, custom_action
  #
  #   editor:
  #     SearchResult: create, read, update, custom_action_for_an_item
  #
