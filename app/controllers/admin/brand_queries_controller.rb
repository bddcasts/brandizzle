...
class Admin::BrandQueriesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     BrandQuery: create, read, update, destroy, custom_action
  #
  #   editor:
  #     BrandQuery: create, read, update, custom_action_for_an_item
  #
