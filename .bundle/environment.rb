...
module Bundler
  ...
  SPECS        = [
        ...
        {:load_paths=>["/Volumes/Storage/cristiduma/.rvm/gems/ruby-1.8.7-p249/gems/capybara-0.3.0/lib"], :loaded_from=>"/Volumes/Storage/cristiduma/.rvm/gems/ruby-1.8.7-p249/specifications/capybara-0.3.0.gemspec", :name=>"capybara"},
        ...
        {:load_paths=>["/Volumes/Storage/cristiduma/projects/rails/brandizzle/brandizzle/vendor/bundler_gems/gems/remarkable-3.1.13/lib"], :loaded_from=>"/Volumes/Storage/cristiduma/projects/rails/brandizzle/brandizzle/vendor/bundler_gems/specifications/remarkable-3.1.13.gemspec", :name=>"remarkable"},
        {:load_paths=>["/Volumes/Storage/cristiduma/projects/rails/brandizzle/brandizzle/vendor/bundler_gems/gems/remarkable_activerecord-3.1.13/lib"], :loaded_from=>"/Volumes/Storage/cristiduma/projects/rails/brandizzle/brandizzle/vendor/bundler_gems/specifications/remarkable_activerecord-3.1.13.gemspec", :name=>"remarkable_activerecord"},
        ...
        {:load_paths=>["/Volumes/Storage/cristiduma/.rvm/gems/ruby-1.8.7-p249/gems/remarkable_rails-3.1.12/lib"], :loaded_from=>"/Volumes/Storage/cristiduma/.rvm/gems/ruby-1.8.7-p249/specifications/remarkable_rails-3.1.12.gemspec", :name=>"remarkable_rails"},
        ...
        {:load_paths=>["/Volumes/Storage/cristiduma/projects/rails/brandizzle/brandizzle/vendor/bundler_gems/gems/whenever-0.4.1/lib"], :loaded_from=>"/Volumes/Storage/cristiduma/projects/rails/brandizzle/brandizzle/vendor/bundler_gems/specifications/whenever-0.4.1.gemspec", :name=>"whenever"},
